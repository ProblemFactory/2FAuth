...
ENV \
    ...
    COMMIT=${COMMIT}
LABEL \
    org.opencontainers.image.authors="https://github.com/ProblemFactory" \
    org.opencontainers.image.version=$VERSION \
    org.opencontainers.image.created=$CREATED \
    org.opencontainers.image.revision=$COMMIT \
    org.opencontainers.image.url="https://github.com/ProblemFactory/2FAuth" \
    org.opencontainers.image.documentation="https://github.com/ProblemFactory/2FAuth" \
    org.opencontainers.image.source="https://github.com/ProblemFactory/2FAuth" \
    org.opencontainers.image.title="2fauth-offline" \
    org.opencontainers.image.description="A web app to manage your Two-Factor Authentication (2FA) accounts with offline PWA support"
